...
Ext.onReady(function () {
    Ext.QuickTips.init();
    var tableModel = new Ext.model.Table
    var fieldModel = new Ext.model.Field;
    var foreignModel = new Ext.model.Foreign;
    var indexFieldModel = new Ext.model.Index_field
    var indexModel = new Ext.model.Index;
    ...
    var fieldStore = Ext.create( 'Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'http://localhost:8080/BookManager//book/field',
            reader: {
                type: 'json',
                root: 'data',
                totalProperty: 'total'
    ...
    var foreignStore = Ext.create( 'Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'http://localhost:8080/BookManager//book/foreign',
            reader: {
                type: 'json',
                root: 'data',
                totalProperty: 'total'
    ...
    var indexStore = Ext.create( 'Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'http://localhost:8080/BookManager//book/index',
            reader: {
                type: 'json',
                root: 'data',
                totalProperty: 'total'
    ...
    var indexFieldStore = Ext.create( 'Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'http://localhost:8080/BookManager//book/indexField',
            reader: {
                root: 'data',
                type: 'json',
                totalProperty: 'total'
        ...
        items: [
            {
                ...
                labelWidth: 30,
                layout: 'column',
                url: 'http://localhost:8080/BookManager/book/save',
    ...
    Ext.Ajax.request({
        url: 'http://localhost:8080/BookManager//book/table',
        method: 'get',
        reader:{
            type: 'json',
            root: 'data',
     ...
     * 字段grid中编辑修改图标的实现
     * */
    function editTableField(tableFieldGrid, rowIndex, colIndex) {
            ...
            items: [
                {
                    ...
                    frame: true,
                    items: [
                        { fieldLabel: 'standard-field-id', name: 'standardFieldId', xtype: 'textfield',
    ...
    function editIndexField(indexFieldGrid, rowIndex, colIndex){
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        { fieldLabel: 'unique', name: 'index_unique', xtype: 'combobox', displayField: 'name',
                            allowBlank: fasle, store: uniqueStore, editable: false}
                    ]
                },
                {
                    layout: 'form',
            ...
            items: [
                {
                    ...
                    items: [
                        { fieldLabel: 'standard-field-id', name: 'standardFieldId', xtype: 'textfield',
                            allowBlank: false, regex: /^\w+$/},
                        { fieldLabel: 'unique', name: 'unique', xtype: 'combobox', store: uniqueStore,
                            allowBlank: false, displayField: 'name', editbale: false},
                        { fieldLabel: 'primary', name: 'primary', xtype: 'combobox', store: primaryStore,
    ...
    Ext.getCmp('btn_save').on('click', function () {
        ...
        tableReturn.foreignList = foreignList;
        ...
        Ext.Ajax.request({
            url: 'http://localhost:8080/BookManager//book/tableSave',

...
public class TableFieldReturn {
    ...
    public TableFieldReturn() {
    }

    public TableFieldReturn(String standardFieldId, boolean primary, boolean unique, String id, boolean notNull, boolean autoIncrease){

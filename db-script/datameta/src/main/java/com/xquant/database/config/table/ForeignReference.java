 ...
 */
package com.xquant.database.config.table;
...
public class ForeignReference extends BaseObject {
    ...
    @Override
    public int hashCode() {
        return HashCodeBuilder.reflectionHashCode(this, new String[]{"mainTable", "referenceField", "foreignField", "name"});
    }

    @Override
    public boolean equals(Object obj) {

        return EqualsBuilder.reflectionEquals(this, obj, new String[]{"mainTable", "referenceField", "foreignField", "name"});
    }

 ...
 */
package com.xquant.database.config.extmetadata;
...
public class ExtendMetadatas {
    ...
    public List<ExtendMetadata> getExtendMetadataList() {
        return extendMetadataList;
    }

    public void setExtendMetadataList(List<ExtendMetadata> extendMetadataList) {
        this.extendMetadataList = extendMetadataList;
    }
}

...
public final class DatabaseTester extends JdbcDatabaseTester {

    private String driverClass;

    public DatabaseTester(final String driverClass, final String connectionUrl, final String username,

 ...
 */
public class TrimBlankTest extends TestCase {
                ...
                new FileNameFileObjectFilter("allnewline\\.page", true), new FileObjectProcessor() {
                    public void process(FileObject fileObject) {
                        try {
                            ...
                            String expectResult = FileUtil.readStreamContent(VFS.resolveFile(fileObject.getAbsolutePath() + ".blank.txt").getInputStream(), "UTF-8");

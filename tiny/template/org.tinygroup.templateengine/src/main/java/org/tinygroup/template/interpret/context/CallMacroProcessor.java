...
public class CallMacroProcessor extends AbstractCallMacroProcessor<TinyTemplateParser.Call_macro_directiveContext> {
    ...
    public Object process(TemplateInterpreter interpreter, TemplateFromContext templateFromContext, TinyTemplateParser.Call_macro_directiveContext parseTree, TemplateContext pageContext, TemplateContext context, TemplateEngineDefault engine, OutputStream outputStream, String fileName) throws Exception {

...
public class JedisConfigs {
    ...
    @XStreamAlias("default-jedis-config")
    private JedisConfig defaultJedisConfig;
    ...
    public JedisConfig getDefaultJedisConfig() {
        return defaultJedisConfig;
    }

    public void setDefaultJedisConfig(JedisConfig defaultJedisConfig) {
        this.defaultJedisConfig = defaultJedisConfig;
    }

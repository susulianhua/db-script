...
public class AuthSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
    ...
    public AuthSSLProtocolSocketFactory(
            final KeyCert cert) {
        super();
        this.keystoreUrl = VFS.resolveFile(cert.getCertPath());
        this.keystorePassword = cert.getPassword();
    ...
    private KeyStore createKeyStore(final URL url, final String password)
        ...
        KeyStore keystore = KeyStore.getInstance(certType == null ? KeyStore.getDefaultType() : certType);
        InputStream is = null;
        try {
            is = url.openStream();

...
public abstract class ClassUtils {
    ...
    public static Class<?> forName(String name, ClassLoader classLoader) throws ClassNotFoundException, LinkageError {
        Assert.assertNotNull(name, "Name must not be null");
    ...
    public static Method getMethodIfAvailable(Class<?> clazz, String methodName, Class<?>... paramTypes) {
        Assert.assertNotNull(clazz, "Class must not be null");
        Assert.assertNotNull(methodName, "Method name must not be null");
        try {
    ...
    public static String convertResourcePathToClassName(String resourcePath) {
        Assert.assertNotNull(resourcePath, "Resource path must not be null");
    ...
    public static String convertClassNameToResourcePath(String className) {
        Assert.assertNotNull(className, "Class name must not be null");
    ...
    public static String addResourcePathToPackagePath(Class<?> clazz, String resourceName) {
        Assert.assertNotNull(resourceName, "Resource name must not be null");
    ...
    public static Class<?> createCompositeInterface(Class<?>[] interfaces, ClassLoader classLoader) {
        ...
        Assert.assertNotNull(classLoader, "ClassLoader must not be null");

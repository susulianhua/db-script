...
public class TestListObjectExtends extends BastTestCast {
    ...
    public void testRun() {
        ...
        PartMentChild part = (PartMentChild) generator.getObject("partMent", null, PartMentChild.class.getName(), this.getClass().getClassLoader(), context);

...
public final class I18nMessageFactory {
    ...
    static {
        ...
        InputStream inputStream = I18nMessageFactory.class
    ...
    private static String getMessage(Map<Locale, List<Properties>> map,
    ...
    /**
     * 指定locale下的resourceMap对应国际化信息
     * @param locale
     * @return
     */
    public static List<Properties> getResourceMessageList(Locale locale) {
        return getMessageList(resourceMap, locale);
    }
     ...
     * @return
     */
    public static List<Properties> getCustomizeResourceMessageList(Locale locale) {
        return getMessageList(customizeResourceMap, locale);
    }

    /**
     * 获取当前方言下resourceMap对应的国际化信息
     * @return
     */
    public static List<Properties> getResourceMessageList() {
        return getResourceMessageList(LocaleUtil.getContext().getLocale());
    }
     ...
     * @return
     */
    public static List<Properties> getCustomizeResourceMessageList() {
        return getCustomizeResourceMessageList(LocaleUtil.getContext().getLocale());
    }

    /**
     * 返回对应locale下的国际化信息list
     * @param map
     * @param locale
     * @return
     */
    private static List<Properties> getMessageList(Map<Locale, List<Properties>> map, Locale locale) {
        List<Properties> propertiesList = map.get(locale);
        if (propertiesList == null) {
            propertiesList = map.get(defaultLocale);
        }

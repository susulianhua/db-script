...
public class StringProtocolInListener implements
    ...
    // context.put(ConstantUtil.KEY, context.get(ConstantUtil.KEY)+"String1");
    // }else{
    // context.put(ConstantUtil.KEY, "String1");
    // }
    // chain.pre(r, context);
    // }
    //
    // public void post(String r, String r1, Context context,

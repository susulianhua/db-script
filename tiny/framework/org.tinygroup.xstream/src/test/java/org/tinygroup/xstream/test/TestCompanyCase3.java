...
public class TestCompanyCase3 extends TestCase {
    public void testXmlToObject() throws Exception {
        XStream companyXstream = init("/company3.xstream.xml");
        ...
        assertEquals("tiny", companyNode.getSubNode("company-name").getContent());
        ...
        assertEquals(1, companyNode.getSubNodes("departmentsa").size());
        assertEquals(1, companyNode.getSubNodes("rolesa").size());
        assertEquals(2, companyNode.getSubNodes("departmentsa").get(0).getSubNodes().size());
    ...
    public XStream init(String path) throws Exception {
        ...
        InputStream inputStream = TestCompanyCase3.class

...
public class ExtendedContainerFactory {
    ...
    public static <T extends BeanContainer<?>> void initBeanContainer(Class<T> clazz, ApplicationContext applicationContext) {
        ...
        try {
            Class<?> cls[] = new Class[]{ApplicationContext.class};
            container = clazz
    ...
    public static BeanContainer<?> getBeanContainer(ClassLoader loader) {
        if (loader == ExtendedContainerFactory.class.getClassLoader()) {
            return container;
        } else {
    ...
    public static void main(String[] args) {
        ...
        ExtendedContainerFactory.initBeanContainer(ExtendedSpringBeanContainer.class, c);
    }
}

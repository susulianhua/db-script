...
public class ServiceHttpChannelLoader {
    ...
    public void addService(ServiceComponent serviceComponent) {
        ...
        if(serviceComponent.getServiceMethods()==null||
                serviceComponent.getServiceMethods().size()==0){
            try {
                ServiceUtil.generateServiceMethod(classType,serviceComponent,getServiceIdGenerateRule());

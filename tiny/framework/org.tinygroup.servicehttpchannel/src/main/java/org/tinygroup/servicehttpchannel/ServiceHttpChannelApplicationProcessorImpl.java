...
public class ServiceHttpChannelApplicationProcessorImpl implements
        ApplicationProcessor {
    private static final Logger LOGGER = LoggerFactory
            .getLogger(ServiceHttpChannelApplicationProcessorImpl.class);
    private CEPCore cepcore;
    private ServiceHttpChannelEventProcessorImpl processor;
...
//		LOGGER.logMessage(LogLevel.DEBUG, "初始化MockServiceProcessor完成");
    ...
    public ServiceHttpChannelEventProcessorImpl getProcessor() {
        return processor;
    }

    public void setProcessor(ServiceHttpChannelEventProcessorImpl processor) {

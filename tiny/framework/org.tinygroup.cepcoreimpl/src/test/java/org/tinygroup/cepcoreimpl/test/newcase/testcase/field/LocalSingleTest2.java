...
public class LocalSingleTest2 extends FieldBaseTest {
    ...
    public void testRegAndUnUnMore() {
        ...
        EventProcessor processor2 = getEventProcessor("local",
                EventProcessor.TYPE_LOCAL, "a,b,c");
    ...
    public void testDoubleRegMore() {
        ...
        addEventProcessorServices(except4, "local", "a,b,c");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "local", EventProcessor.TYPE_LOCAL, "a,b,c");
    ...
    public void testDoubleRegLess() {
        ...
        // ------------------------------
        EventProcessor processor2 = getEventProcessor("local",
                EventProcessor.TYPE_LOCAL, "a");
        cepcore.registerEventProcessor(processor2);
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "local", "a");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "local", EventProcessor.TYPE_LOCAL, "a");
        myAssertProcessorMap(except5, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap(""), cepcore);
        // 服务：处理器列表
        ...
        myAssertServiceIdMap(except6, cepcore);
        // 本地服务列表
        myAssertLocalServices(createLocalServices("a"), cepcore);
        // 本地服务Map
        myAssertLocalServiceMap(createLocalServiceMap("a"), cepcore);
    }

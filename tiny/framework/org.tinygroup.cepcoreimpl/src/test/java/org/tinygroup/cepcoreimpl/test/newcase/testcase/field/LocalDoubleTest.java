...
public class LocalDoubleTest extends FieldBaseTest {
    ...
    public void testSameRRUU() {
        ...
        String firstEventProssorId = "local-1";
        EventProcessor firstProcessor = getEventProcessor(firstEventProssorId,
                EventProcessor.TYPE_LOCAL, firstIds);
        // 第一个processor注册
        ...
        // 第二个processor初始化数据
        String secIds = "a,b,c";
        String secEventProssorId = "local-2";
        EventProcessor secProcessor = getEventProcessor(secEventProssorId,
                EventProcessor.TYPE_LOCAL, secIds);
        // 第二个processor注册

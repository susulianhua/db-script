...
public class RemoteDoubleTest extends FieldBaseTest {
    public void testSameRRUU() {
        ...
        // 注册
        // ------------------------------
        EventProcessor processor2 = getEventProcessor("remote1",
                EventProcessor.TYPE_REMOTE, "a,b");
        cepcore.registerEventProcessor(processor2);
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "remote1", "a,b");
        addEventProcessorServices(except4, "remote", "a,b");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "remote", EventProcessor.TYPE_REMOTE, "a,b");
        addProcessorMap(except5, "remote1", EventProcessor.TYPE_REMOTE, "a,b");
        ...
        addEventProcessorServices(exceptu1, "remote1", "a,b");
        myAssertEventProcessorServices(exceptu1, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> exceptu2 = createProcessorMap();
        addProcessorMap(exceptu2, "remote1", EventProcessor.TYPE_REMOTE, "a,b");
    ...
    public void testDifferRRUU() {
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "remote1", "c,d");
        addEventProcessorServices(except4, "remote", "a,b");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "remote", EventProcessor.TYPE_REMOTE, "a,b");
        addProcessorMap(except5, "remote1", EventProcessor.TYPE_REMOTE, "c,d");
        myAssertProcessorMap(except5, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("a,b,c,d"), cepcore);
        // 服务：处理器列表
        Map<String, List<EventProcessor>> except6 = createServiceIdMap(cepcore);
        List<EventProcessor> list6 = new ArrayList<EventProcessor>();
        list6.add(processor);
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> exceptu1 = createEventProcessorServices();
        addEventProcessorServices(exceptu1, "remote1", "c,d");
        myAssertEventProcessorServices(exceptu1, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> exceptu2 = createProcessorMap();
        addProcessorMap(exceptu2, "remote1", EventProcessor.TYPE_REMOTE, "c,d");
        myAssertProcessorMap(exceptu2, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("c,d"), cepcore);
        // 服务：处理器列表
        Map<String, List<EventProcessor>> exceptu3 = createServiceIdMap(cepcore);
        List<EventProcessor> listu3 = new ArrayList<EventProcessor>();
        listu3.add(processor2);
    ...
    public void testCrossRRUU() {
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "remote1", "a,c");
        addEventProcessorServices(except4, "remote", "a,b");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "remote", EventProcessor.TYPE_REMOTE, "a,b");
        addProcessorMap(except5, "remote1", EventProcessor.TYPE_REMOTE, "a,c");
        myAssertProcessorMap(except5, cepcore);
        // 远程服务列表
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> exceptu1 = createEventProcessorServices();
        addEventProcessorServices(exceptu1, "remote1", "a,c");
        myAssertEventProcessorServices(exceptu1, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> exceptu2 = createProcessorMap();
        addProcessorMap(exceptu2, "remote1", EventProcessor.TYPE_REMOTE, "a,c");
        myAssertProcessorMap(exceptu2, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("a,c"), cepcore);
        // 服务：处理器列表
        Map<String, List<EventProcessor>> exceptu3 = createServiceIdMap(cepcore);
        List<EventProcessor> listu3 = new ArrayList<EventProcessor>();
        listu3.add(processor2);
    ...
    public void testCrossRURU() {
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "remote1", "c,a");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "remote1", EventProcessor.TYPE_REMOTE, "c,a");
        myAssertProcessorMap(except5, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("c,a"), cepcore);
        // 服务：处理器列表
        Map<String, List<EventProcessor>> except6 = createServiceIdMap(cepcore);
        List<EventProcessor> list6 = new ArrayList<EventProcessor>();
        list6.add(processor2);

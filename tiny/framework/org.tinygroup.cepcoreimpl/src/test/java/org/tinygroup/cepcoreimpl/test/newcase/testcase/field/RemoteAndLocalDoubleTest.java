...
public class RemoteAndLocalDoubleTest extends FieldBaseTest {
    public void testSameRRUU() {
        ...
        // 注册
        // ------------------------------
        EventProcessor processor2 = getEventProcessor("local",
        ...
        addEventProcessorServices(exceptu1, "local", "a,b");
        myAssertEventProcessorServices(exceptu1, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> exceptu2 = createProcessorMap();
        addProcessorMap(exceptu2, "local", EventProcessor.TYPE_LOCAL, "a,b");
    ...
    public void testSameRRUU2() {
        ...
        Map<String, EventProcessor> except2 = createProcessorMap();
        addProcessorMap(except2, "remote", EventProcessor.TYPE_REMOTE, "a,b");
        addProcessorMap(except2, "local", EventProcessor.TYPE_REMOTE, "a,b");
        myAssertProcessorMap(except2, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("a,b"), cepcore);
        // 服务：处理器列表
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> exceptu4 = createEventProcessorServices();
        addEventProcessorServices(exceptu4, "remote", "a,b");
        myAssertEventProcessorServices(exceptu4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> exceptu5 = createProcessorMap();
        addProcessorMap(exceptu5, "remote", EventProcessor.TYPE_REMOTE, "a,b");
        myAssertProcessorMap(exceptu5, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("a,b"), cepcore);
        // 服务：处理器列表
        Map<String, List<EventProcessor>> exceptu6 = createServiceIdMap(cepcore);
        List<EventProcessor> listu6 = new ArrayList<EventProcessor>();
        listu6.add(processor);
        exceptu6.put("a", listu6);
        exceptu6.put("b", listu6);
        myAssertServiceIdMap(exceptu6, cepcore);
        // 本地服务列表
        myAssertLocalServices(createLocalServices(""), cepcore);
        // 本地服务Map
    ...
    public void testDifferRRUU() {
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "local", "c,d");
        addEventProcessorServices(except4, "remote", "a,b");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "remote", EventProcessor.TYPE_REMOTE, "a,b");
        addProcessorMap(except5, "local", EventProcessor.TYPE_LOCAL, "c,d");
        myAssertProcessorMap(except5, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("a,b"), cepcore);
        // 服务：处理器列表
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> exceptu1 = createEventProcessorServices();
        addEventProcessorServices(exceptu1, "local", "c,d");
        myAssertEventProcessorServices(exceptu1, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> exceptu2 = createProcessorMap();
        addProcessorMap(exceptu2, "local", EventProcessor.TYPE_LOCAL, "c,d");
        myAssertProcessorMap(exceptu2, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap(""), cepcore);
        // 服务：处理器列表
    ...
    public void testCrossRRUU() {
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "local", "a,c");
        addEventProcessorServices(except4, "remote", "a,b");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "remote", EventProcessor.TYPE_REMOTE, "a,b");
        addProcessorMap(except5, "local", EventProcessor.TYPE_REMOTE, "a,c");
        myAssertProcessorMap(except5, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap("a,b"), cepcore);
        // 服务：处理器列表
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> exceptu1 = createEventProcessorServices();
        addEventProcessorServices(exceptu1, "local", "a,c");
        myAssertEventProcessorServices(exceptu1, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> exceptu2 = createProcessorMap();
        addProcessorMap(exceptu2, "local", EventProcessor.TYPE_LOCAL, "a,c");
        myAssertProcessorMap(exceptu2, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap(""), cepcore);
        // 服务：处理器列表
    ...
    public void testCrossRURU() {
        ...
        // EventProcessorID：Service列表
        Map<String, List<ServiceInfo>> except4 = createEventProcessorServices();
        addEventProcessorServices(except4, "local", "c,a");
        myAssertEventProcessorServices(except4, cepcore);
        // EventProcessorID：EventProcessor
        Map<String, EventProcessor> except5 = createProcessorMap();
        addProcessorMap(except5, "local", EventProcessor.TYPE_LOCAL, "c,a");
        myAssertProcessorMap(except5, cepcore);
        // 远程服务列表
        myAssertRemoteServiceMap(createRemoteServiceMap(""), cepcore);
        // 服务：处理器列表

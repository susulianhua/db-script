 ...
 */
public class QueryForObjectListComponent extends AbstractJdbcTemplateComponent {
    private static final Logger LOGGER = LoggerFactory
            .getLogger(QueryForObjectListComponent.class);
    ...
    public void execute(Context context) {
        LOGGER.logMessage(LogLevel.INFO, "数据库查询组件开始执行，返回Objectlist。查询语句：{0}",
                sql);
        try {

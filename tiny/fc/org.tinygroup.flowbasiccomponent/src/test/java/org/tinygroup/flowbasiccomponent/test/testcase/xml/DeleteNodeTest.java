 ...
 * @author qiucn
 */
public class DeleteNodeTest extends AbstractFlowComponent {

    /**
     *
     */
    public void testXmlDeleteNode() {
        Context context = ContextFactory.getContext();
        context.put("xml", getXml());
        context.put("nodePath", "/CFX/HEAD/VER");
        context.put("resultKey", "result");
        context.put("result", "");
        Event e = Event.createEvent("xmlDeleteNodeFlowTest", context);
        cepcore.process(e);

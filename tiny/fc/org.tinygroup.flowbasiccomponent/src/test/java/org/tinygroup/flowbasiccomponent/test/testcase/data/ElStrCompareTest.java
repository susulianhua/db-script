 ...
 * @author qiucn
 */
public class ElStrCompareTest extends AbstractFlowComponent {

    public void testElStrCompareTrue() {
        Context context = ContextFactory.getContext();
        context.put("a", "abc");
        context.put("b", "abc");
        context.put("el", "result=(a==b)?true:false");
        Event e = Event.createEvent("elStrCompareTestFlow", context);
        cepcore.process(e);
        assertEquals(true, e.getServiceRequest().getContext().get("result"));
    }

    public void testElStrCompareFalse() {
        Context context = ContextFactory.getContext();
        context.put("a", "abc");
        context.put("b", "abc");
        context.put("el", "result=(a!=b)?true:false");

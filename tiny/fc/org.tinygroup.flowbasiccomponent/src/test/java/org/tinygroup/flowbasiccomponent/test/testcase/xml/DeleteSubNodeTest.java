 ...
 * @author qiucn
 */
public class DeleteSubNodeTest extends AbstractFlowComponent {

    /**
     *
     */
    public void testXmlDeleteSubNode() {
        Context context = ContextFactory.getContext();
        context.put("xml", getXml());
        context.put("nodePath", "/CFX/HEAD");
        context.put("resultKey", "result");
        context.put("result", "");
        Event e = Event.createEvent("xmlDeleteSubNodeFlowTest", context);
        cepcore.process(e);
        assertEquals("<VER>1.0</VER><SRC>100000000000</SRC><DES>114200000000</DES><APP>TIPS</APP><MsgNo>2001</MsgNo><MsgID>20050830200100087356</MsgID><MsgRef>12345678901234567890</MsgRef><WorkDate>20050824</WorkDate>", e.getServiceRequest().getContext().get("result"));
        assertEquals("<CFX><HEAD></HEAD><MSG><SingleReturn2001><OriTaxOrgCode>14200000000</OriTaxOrgCode><OriTraNo>00000016</OriTraNo><OriEntrustDate>20050827</OriEntrustDate><TaxVouNo>1</TaxVouNo><TaxDate>20050824</TaxDate><Result>90000</Result><AddWord>成功</AddWord></SingleReturn2001></MSG></CFX>", e.getServiceRequest().getContext().get("xml").toString());
    }

...
public class FlowTest extends TestCase {
    public void testCallMethodPlus() {
        ...
        c.put("i", 1);
        c.put("j", 2);
        FlowTestUtil.executePage("callComputePlus", c);
        int result = (Integer) c.get("plusResult");
    ...
    public void testCallBeanMethod() {
        ...
        a.put("name", "test");
        FlowTestUtil.executePage("callBeanMethod", a);
    ...
    public void testCallEl() {
        Context c = new ContextImpl();
        c.put("age", 12);
        FlowTestUtil.executePage("callEl", c);
        int result = (Integer) c.get("elResult");
    ...
    public void testContextToObject() {
        ...
        c.put("age", 12);
        c.put("flag", true);
        FlowTestUtil.executePage("flowContext2Object", c);

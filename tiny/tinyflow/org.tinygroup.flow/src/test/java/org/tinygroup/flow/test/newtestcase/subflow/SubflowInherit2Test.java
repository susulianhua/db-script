...
public class SubflowInherit2Test extends AbstractFlowComponent {
    ...
    public void testException1() {
        ...
        flowExecutor.execute("subflowInherit2", "begin", context);
        ...
        Event e = Event.createEvent("subflowInherit2", context2);
        cepcore.process(e);
    ...
    public void testException2() {
        ...
        assertEquals(4, Integer.valueOf(context.get("c").toString()).intValue());
        ...
        assertEquals(4, Integer.valueOf(e.getServiceRequest().getContext().get("c").toString()).intValue());
    }

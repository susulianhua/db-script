 ...
 */
public class SubflowInheritTest extends AbstractFlowComponent {
    ...
    public void testException1() {
        ...
        flowExecutor.execute("subflowInherit1", "begin", context);
        ...
        Event e = Event.createEvent("subflowInherit1", context2);
        cepcore.process(e);

...
public class FlowParamComponentTest extends AbstractFlowComponent {
    ...
    /**
     * @description： 参数el传递的类型为el表达式，参数值为 el,此时组件中参数el实际值为上下文中的key为el的值,如果上下文中不存在这个key，则值为null
     * @author: qiuqn
...
//	}
    ...
    /**
     * @description： 参数el传递的类型为el表达式，参数值为  'a=3'(两个单引号，表示这是一个字符串),此时组件中参数el实际值为 a=3
     * @author: qiuqn
     * @version: 2016年4月13日上午9:55:51
     */
    ...
    /**
     * @description： 参数el传递的类型为el表达式，参数值为  b='a=4'(el表达式，这里是讲字符串“a=4”赋值给b)
    ...
    /**
     * @description： 参数str传递的类型为java.lang.String，参数值为 b='testStr' ，此时组件中参数str实际值也为 b='testStr'
    ...
    /**
     * @description： 参数str传递的类型为java.lang.String，参数值为 ${strflow}，此时组件中参数str实际值为上下文中的key为strflow的值
     * @author: qiuqn
     * @version: 2016年4月13日上午9:55:51
     */

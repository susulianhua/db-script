...
public class WebserviceUtil {
    ...
    private static Class loadServiceClass(ServiceInfo serviceInfo,
        ...
        String methodName = StringUtil.replace(serviceInfoId, ".", "");
        method2ServiceId.put(methodName, serviceInfoId);
        String className = methodName.substring(0, 1).toUpperCase()
    ...
    public static InputStream getXmlInputStream(ServiceInfo serviceInfo,
        ...
        String methodName = StringUtil.replace(serviceId, ".", "");
        String className = methodName.substring(0, 1).toUpperCase()
                + methodName.substring(1);
        className = packageName + "." + className;
    ...
    private static CtMethod getCtMethod(CtClass cc, ServiceInfo serviceInfo)
        ...
        // 创建新CtMethod对象
        String methodName = StringUtil.replace(serviceInfo.getServiceId(), ".", "");

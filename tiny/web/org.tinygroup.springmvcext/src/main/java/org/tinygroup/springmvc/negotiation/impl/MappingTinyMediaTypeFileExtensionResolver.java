 ...
 * @author renhui
 */
public class MappingTinyMediaTypeFileExtensionResolver implements MediaTypeFileExtensionResolver {
     ...
     */
    public MappingTinyMediaTypeFileExtensionResolver(Map<String, MediaType> mediaTypes) {
        if (mediaTypes != null) {

...
public class BeanDefinitionProxy extends GenericBeanDefinition implements BeanDefinition {
    ...
    public MethodOverrides getMethodOverrides() {
        MethodOverrides currentMethodOverrides = ((AbstractBeanDefinition) currentBeanDefinition).getMethodOverrides();
        MethodOverrides mergedMethodOverrides = ((AbstractBeanDefinition) mergedBeanDefinition).getMethodOverrides();

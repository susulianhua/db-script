...
public class JspUtil {
    ...
    public static String interpreterCall(boolean isTagFile,
        ...
        if (expectedType == javax.el.ValueExpression.class) {
            ...
            return "org.tinygroup.jspengine.runtime.PageContextImpl.getValueExpression"
        ...
        if (expectedType == javax.el.MethodExpression.class) {
            ...
            return "org.tinygroup.jspengine.runtime.PageContextImpl.getMethodExpression"
                    + "(" + Generator.quote(expression) + ", "
                    + "(PageContext)" + jspCtxt + ", "
                    + fnmapvar + ", "
        ...
        StringBuffer call = new StringBuffer(
                "(" + targetType + ") "
                        + "org.tinygroup.jspengine.runtime.PageContextImpl.evaluateExpression"
                        + "(" + Generator.quote(expression) + ", "
                        + targetType + ".class, "
                        + "(PageContext)" + jspCtxt
                        + ", " + fnmapvar
    ...
    public static String coerceToPrimitiveBoolean(String s,
        ...
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToBoolean(" + s + ")";
        } else {
    ...
    public static String coerceToBoolean(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Boolean) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Boolean.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToPrimitiveByte(String s,
                                               boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToByte(" + s + ")";
        } else {
            if (s == null || s.length() == 0)
                return "(byte) 0";
            else
    ...
    public static String coerceToByte(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Byte) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Byte.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToChar(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToChar(" + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(char) 0";
            } else {
    ...
    public static String coerceToCharacter(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Character) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Character.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToPrimitiveDouble(String s,
                                                 boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToDouble(" + s + ")";
        } else {
            if (s == null || s.length() == 0)
                return "(double) 0";
            else
    ...
    public static String coerceToDouble(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Double) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Double.class)";
        } else {
            if (s == null || s.length() == 0) {
                return "new Double(0)";
            } else {
    ...
    public static String coerceToPrimitiveFloat(String s,
                                                boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToFloat(" + s + ")";
        } else {
            if (s == null || s.length() == 0)
                return "(float) 0";
            else
    ...
    public static String coerceToFloat(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Float) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Float.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToInt(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToInt(" + s + ")";
        } else {
            if (s == null || s.length() == 0)
                return "0";
            else
    ...
    public static String coerceToInteger(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Integer) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Integer.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToPrimitiveShort(String s,
                                                boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToShort(" + s + ")";
        } else {
            if (s == null || s.length() == 0)
                return "(short) 0";
            else
    ...
    public static String coerceToShort(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Short) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Short.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToPrimitiveLong(String s,
                                               boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerceToLong(" + s + ")";
        } else {
            if (s == null || s.length() == 0)
                return "(long) 0";
            else
    ...
    public static String coerceToLong(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Long) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce(" + s + ", Long.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToEnum(String s, String enumClass, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(Enum) org.tinygroup.jspengine.runtime.JspRuntimeLibrary.coerce("
                    + s + "," + enumClass + ".class)";
        } else {
            if (s == null || s.length() == 0) {
                return "null";

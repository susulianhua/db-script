...
public class Compiler {
    private static org.tinygroup.jspengine.org.apache.commons.logging.Log commonsLog =
            org.tinygroup.jspengine.org.apache.commons.logging.LogFactory.getLog(Compiler.class);
    private static org.tinygroup.jspengine.org.apache.commons.logging.Log noOpLog =
    ...
    private void addClassPath(String classPath,
                              ArrayList<File> cpath, HashSet<String> paths) {
        if (classPath == null) {
            return;
        }
    ...
    private void generateClass()
        ...
        if (options.isDelegate()) {
            addClassPath(sysClassPath, cpath, paths);
            addClassPath(classpath, cpath, paths);
            if (log.isDebugEnabled()) {
                String sep = System.getProperty("path.separator");
            ...
            if (log.isDebugEnabled()) {
                String sep = System.getProperty("path.separator");
                log.debug("Using classpath: " + classpath + sep + sysClassPath);
            }
        }

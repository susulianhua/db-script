...
class Generator {
    ...
    private void generateTagHandlerInit() {
        ...
        for (int i = 0; i < tagHandlerPoolNames.size(); i++) {
            ...
            out.print(
                    " = org.tinygroup.jspengine.runtime.TagHandlerPool.getTagHandlerPool(");
            if (ctxt.isTagFile()) {
                out.print("config");
            } else {
    ...
    private void genPreambleStaticInitializers() throws JasperException {
        out.printil("private static final JspFactory _jspxFactory = new org.tinygroup.jspengine.runtime.JspFactoryImpl();");
        out.println();
    ...
    private void genPreambleClassVariableDeclarations(String className)
        ...
        if (isPoolingEnabled) {
            if (!tagHandlerPoolNames.isEmpty()) {
                for (int i = 0; i < tagHandlerPoolNames.size(); i++) {
                    out.printil(
                            "private org.tinygroup.jspengine.runtime.TagHandlerPool "
        ...
        out.printil("private org.tinygroup.jspengine.runtime.ResourceInjector "
    ...
    private void generatePreamble(Node.Nodes page) throws JasperException {
        ...
        if (pageInfo.isErrorPage()) {
            out.printil(
                    "Throwable exception = org.tinygroup.jspengine.runtime.JspRuntimeLibrary.getThrowable(request);");
            out.printil(
        ...
        out.printil("_jspx_resourceInjector = (org.tinygroup.jspengine.runtime.ResourceInjector) application.getAttribute(\"com.sun.appserv.jsp.resource.injector\");");
        out.println();
    }
    ...
    private void generateTagHandlerPostamble(TagInfo tagInfo) {
        ...
        out.pushIndent();
        out.printil(
                "((org.tinygroup.jspengine.runtime.JspContextWrapper) jspContext).syncEndTagFile();");
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
    ...
    private void generateSetJspContext(TagInfo tagInfo) {
        ...
        if (aliasSeen) {
            out.printil(
                    "this.jspContext = new org.tinygroup.jspengine.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, aliasMap);");
        } else {
            out.printil(
                    "this.jspContext = new org.tinygroup.jspengine.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, null);");
        }
        out.popIndent();
        out.printil("}");
        out.println();
    ...
    private void generatePageScopedVariables(JasperTagInfo tagInfo) {
        ...
        for (int i = 0; i < attrInfos.length; i++) {
            ...
            if (attrInfos[i].isDeferredValue()) {
                ...
                out.printin("org.tinygroup.jspengine.runtime.PageContextImpl.setValueVariable(");
            ...
            if (attrInfos[i].isDeferredMethod()) {
                ...
                out.printin("org.tinygroup.jspengine.runtime.PageContextImpl.setMethodVariable(");
                out.print("_jspx_page_context, ");
                out.print(quote(attrName));
                out.print(", ");
                out.print(toGetterMethod(attrName));
    ...
    private static class FragmentHelperClass {
        ...
        public void generatePreamble() {
            ...
            out.printil(
                    "    extends " + "org.tinygroup.jspengine.runtime.JspFragmentHelper");
            out.printil("{");
            out.pushIndent();
            out.printil(
    ...
    class GenerateVisitor extends Node.Visitor {
        ...
        private String attributeValue(
            ...
            if (attr.isExpression()) {
                if (encode) {
                    return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.URLEncode(String.valueOf("
                            + v
                ...
                v = JspUtil.interpreterCall(
                        ...
                        null, null, null);
                if (encode) {
                    return "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.URLEncode("
                            + v
                            + ", request.getCharacterEncoding())";
                }
                return v;
        ...
        public void visit(Node.IncludeAction n) throws JasperException {
            ...
            out.printin(
                    "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.include(request, response, "
                            + pageParam);
        ...
        public void visit(Node.GetProperty n) throws JasperException {
            ...
            if (beanInfo.checkVariable(name)) {
                ...
                out.printil(
                        "out.write(org.tinygroup.jspengine.runtime.JspRuntimeLibrary.toString("
                                + "((("
                                + beanName
                ...
                out.printil(
                        "out.write(org.tinygroup.jspengine.runtime.JspRuntimeLibrary.toString"
                                + "(org.tinygroup.jspengine.runtime.JspRuntimeLibrary.handleGetProperty"
                                + "(_jspx_page_context.findAttribute(\""
                                + name
                                + "\"), \""
                                + property
        ...
        public void visit(Node.SetProperty n) throws JasperException {
            ...
            if ("*".equals(property)) {
                out.printil(
                        "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.introspect("
                                + "_jspx_page_context.findAttribute("
                                + "\""
                                + name
                                + "\"), request);");
                ...
                out.printil(
                        "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.introspecthelper("
                                + "_jspx_page_context.findAttribute(\""
                                + name
                                + "\"), \""
                                + property
                ...
                out.printil(
                        "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.handleSetProperty("
                                + "_jspx_page_context.findAttribute(\""
                                + name
                                + "\"), \""
                                + property
                ...
                out.printil(
                        "org.tinygroup.jspengine.runtime.JspRuntimeLibrary.handleSetPropertyExpression("
                                + "_jspx_page_context.findAttribute(\""
                                + name
                                + "\"), \""
                                + property
        ...
        public void visit(Node.TemplateText n) throws JasperException {
            ...
            if (genBytes || ctxt.getOptions().genStringAsCharArray()) {
                ...
                if (genBytes) {
                    out.printin("((org.tinygroup.jspengine.runtime.JspWriterImpl)out).write(_jspx_same_encoding(response.getCharacterEncoding()), ");
                    out.print(arrayName);
                    out.print(", ");
                    out.print(arrayName);
                    out.println("S);");
        ...
        public void visit(Node.InvokeAction n) throws JasperException {
            ...
            // page
            out.printil(
                    "((org.tinygroup.jspengine.runtime.JspContextWrapper) this.jspContext).syncBeforeInvoke();");
        ...
        private String convertString(
            ...
            if (propEditorClass != null) {
                ...
                return "("
                        + className
                        + ")org.tinygroup.jspengine.runtime.JspRuntimeLibrary.getValueFromBeanInfoPropertyEditor("
                        + className
                        + ".class, \""
                        + attrName
                        + "\", "
                ...
                return "("
                        + className
                        + ")org.tinygroup.jspengine.runtime.JspRuntimeLibrary.getValueFromPropertyEditorManager("
                        + className
                        + ".class, \""
                        + attrName
                        + "\", "
        ...
        private void generateJspFragment(Node n, String tagHandlerVar)
            ...
            // the org.tinygroup.jspengine.runtime package as a support class.

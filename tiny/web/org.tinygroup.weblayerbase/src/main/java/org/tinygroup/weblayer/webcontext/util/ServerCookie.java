...
public class ServerCookie {
    ...
    private static final DateFormat OLD_COOKIE_FORMAT = new SimpleDateFormat(OLD_COOKIE_PATTERN, Locale.US);
    private static final String ancientDate = OLD_COOKIE_FORMAT.format(new Date(10000));
    // -------------------- utils --------------------
        ...
        if (maxAge >= 0) {
            ...
            if (version == 0 || ALWAYS_ADD_EXPIRES) {
                ...
                if (maxAge == 0) {
                    ...
                    buf.append(OLD_COOKIE_FORMAT.format(new Date(System.currentTimeMillis() + maxAge * 1000L)));
                }
            }
        } else {
            // RFC2965 Discard

...
public abstract class AbstractFileItem implements FileItem,
     ...
     *                      not specified.
     * @param isFormField   Whether or not this item is a plain form field, as opposed to
     *                      a file upload.
     ...
     * @param repository    The data repository, which is the directory in which files
    ...
    public AbstractFileItem(String fieldName, String contentType,
                            boolean isFormField, boolean saveInFile, String fileName,
                            int sizeThreshold, boolean keepFormFieldInMemory, File repository,
                            HttpServletRequest request, FileUploadReName fileUploadRename) {
